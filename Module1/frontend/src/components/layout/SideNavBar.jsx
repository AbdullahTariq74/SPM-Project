...
export default function SideNavBar() {
  ...
  return (
    <aside className="fixed left-0 top-16 bottom-0 w-64 bg-slate-50 dark:bg-[#001736] border-r border-slate-200 dark:border-white/5 p-4 z-40 overflow-y-auto custom-scrollbar transition-colors duration-500">
