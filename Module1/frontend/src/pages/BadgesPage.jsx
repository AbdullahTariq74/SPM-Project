  ...
  return (
    <div className="space-y-12 animate-fade-in max-w-5xl mx-auto">
      <div className="text-center space-y-2">
        ...
        <p className="text-slate-500 dark:text-slate-400 text-sm max-w-md mx-auto">Showcasing your skills, contributions, and milestones within the Nexus ecosystem.</p>
      </div>
